...
# So far we've only talked about 'It' and 'Describe' Pester building blocks, there are two more, 'Context' and 'InModuleScope', Context is the first we will talk about 

Describe "Context Block Demo" {

    # As with the other Pester commands - 'Describe' and 'It' etc Context takes -Name and -Fixture Parameters, but these are almost always used positionally.
